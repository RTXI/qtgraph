...
hidden if the `qtgraph_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `qtgraph_DEVELOPER_MODE` to the configure
...
Runs the executable target `qtgraph_exe`.
